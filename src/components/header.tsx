...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-2 border-b bg-background/80 px-2 backdrop-blur-sm md:gap-4 md:px-6">
      <div className="flex items-center gap-2">
        <Zap className="h-6 w-6 text-primary" />
        <h1 className="text-lg font-semibold tracking-tight md:text-xl">VoltView</h1>
      </div>
